 ...
 const Nav = () => {
    ...
    return(
        ...
        <div className="sm:flex   items-center  justify-between  md:px-4 px-2 ">
            ...
            <div className={`mt-2 sm:mt-0 flex flex-col sm:flex-row items-center sm:gap-5 font-serif transition-all duration-500 sm:static ${open ? "sm:flex opacity-100":"hidden sm:flex"} sm:opacity-100 opacity-0`}>
